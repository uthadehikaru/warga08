<div class="container mx-auto px-4 py-8">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('posyandu.dashboard', ['menu' => 'posyandu', 'type' => $type]) }}" class="ml-1 text-sm font-medium text-blue-700 hover:text-blue-600 md:ml-2">Posyandu {{ $type }}</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
    ...
    <h1 class="text-xl text-center text-primary font-bold my-2">Rekapitulasi</h1>
        ...
        <div class="mt-2">
            <div class="w-full text-primary hover:text-blue-200 p-4 flex justify-between items-center gap-2">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('posyandu.teens.records', $history->healthRecord->user->nik) }}" class="btn btn-sm btn-info">POS {{ $history->step+1 }}</a>
                </div>
            </div>
        </div>
        @empty
