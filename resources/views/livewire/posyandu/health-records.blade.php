<div>
    <div class="container mx-auto px-4 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('posyandu.teens.index') }}" class="ml-1 text-sm font-medium text-blue-700 hover:text-blue-600 md:ml-2">Warga</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex justify-between items-center my-4">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('posyandu.teens.form', ['nik' => $warga->nik]) }}" class="btn btn-sm btn-primary p-1">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mb-4">
            ...
            <div tabindex="0" class="collapse bg-base-100 border-base-300 border">
                ...
                <div class="collapse-title font-semibold flex justify-between items-center">
                    ...
                    @else
                        <span class="badge badge-sm badge-warning p-2">Langkah {{ $healthHistory->step }}</span>
                    @endif
                </div>
                <div class="collapse-content text-sm flex flex-col gap-2" onclick="event.stopPropagation()">
                    ...
                    <div class="flex justify-between gap-2">
                        ...
                        <a href="https://wa.me/{{ $healthHistory->healthRecord->user->phone }}?text={{ $healthHistory->summary }}" target="_blank" class="btn btn-sm btn-success p-1">
                            whatsapp
                        </a>
                        
                        <button wire:click="delete({{ $healthHistory->id }})" onclick="return confirm('Apakah anda yakin ingin menghapus riwayat kesehatan ini?')" class="btn btn-sm btn-error p-1">
                            hapus <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                </svg>
                    </button>
                    </div>
