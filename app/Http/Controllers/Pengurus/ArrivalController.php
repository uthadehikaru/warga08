...
class ArrivalController extends Controller
{
    ...
    {
        $arrivals = Arrival::latest();
        if(Auth::user()->role=='rt'){
            $arrivals->where('rt',Auth::user()->rt);
        }
        $data['arrivals'] = $arrivals->paginate();
        return view('pengurus.arrival.index', $data);
    }
    ...
    {
        $data['request'] = Arrival::findOrFail($id);
